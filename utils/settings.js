const setting = [
  {
    setting: {
      ...
      shop_name: "Freshmart",
      address: "Stall No. 14, Ground Floor, City Market, Muindi Mbingu Street",
      ...
      default_time_zone: "Nairobi/Kenya",
  ...
  },
  {
    setting: {
      navbar: {
        ...
        term_and_condition_status: false,
      ...
      home: {
        ...
        quick_delivery_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our Freshmart shop and get some special offers. See Our latest discounted products from here and get a special discount.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Freshmart-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
        },
        ...
        daily_need_title: {
          en: "Get Your Daily Needs From Our Freshmart Store",
          de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our Freshmart shop and get some special offers.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Freshmart-Shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      contact_us: {
        ...
        email_box_email: {
          en: "info@Freshmart.com ",
          de: "info@Freshmart.com",
        },
        email_box_text: {
        ...
        address_box_address_two: {
          en: "Stall No. 14, Ground Floor, City Market, Muindi Mbingu Street ",
          de: "Stall No. 14, Ground Floor, City Market, Muindi Mbingu Street, ",
        },
        address_box_address_three: {
          en: "Stall No. 14, Ground Floor ",
          de: "Stall No. 14, Ground Floor",
        },
        form_title: {
      ...
      faq: {
        ...
        faq_one: {
          en: "How does the Freshmart work?",
          de: "Wie funktioniert der Freshmart?",
        },
        description_one: {
      ...
      footer: {
        ...
        shipping_card: {
          en: "Free Shipping From KES500.00",
          de: "Kostenloser Versand ab 500,00 KES",
        },
        support_card: {
      ...
      slug: {
        ...
        card_description_one: {
          en: "Free shipping applies to all orders over shipping KES 5000",
          de: "Kostenloser Versand gilt für alle Bestellungen über 100 KES Versandkosten",
        },
        ...
        card_description_seven: {
          en: "Delivery from our pick point Stall No. 14, Ground Floor, City Market, Muindi Mbingu Street, Nairobi",
          de: "Lieferung von unserem Abholpunkt Stall No. 14, Ground Floor, City Market, Muindi Mbingu Street, Nairobi.",
        },
      },
    },
